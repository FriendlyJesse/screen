    ...
    const update = () => {
      ...
      options.value = {
        ...
        globe: {
          ...
          environment: require('./images/star-bg.jpg'),
          heightTexture: require('./images/datav-gl-texture.jpg'),
          ...
          light: {
            ...
            ambientCubemap: {
              texture: require('./images/datav-gl-texture.jpg'),
              exposure: 1,
