...
export default function () {
  ...
  const salesListkData = ref(salesListMockData)
  let task: number
  ...
  onMounted(() => {
    task = setInterval(() => {
      ...
      _riderData.orderData.data1 = _riderData.orderData.data1.map(item => item + random(1000))
      _riderData.orderData.data2 = _riderData.orderData.data2.map(item => item + random(1000))
      _riderData.rateData.data1 = _riderData.orderData.data1.map(item => item + random(1000))
      _riderData.rateData.data2 = _riderData.orderData.data2.map(item => item + random(1000))
      riderData.value = _riderData

      const _hotCategoryData = { ...hotCategoryData.value }
      _hotCategoryData.data1.data1 = _hotCategoryData.data1.data1.map(item => item + random(1000))
      _hotCategoryData.data1.data2 = _hotCategoryData.data1.data2.map(item => item + random(1000))
      _hotCategoryData.data2.data1 = _hotCategoryData.data2.data1.map(item => item + random(1000))
      _hotCategoryData.data2.data2 = _hotCategoryData.data2.data2.map(item => item + random(1000))
